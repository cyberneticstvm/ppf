        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('POST', route('category.update', $category->id))->class('theme-form')->acceptsFiles()->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="col-form-label pt-0 req" for="name">Category Name / Title </label>
                                        {{ html()->text('name', $category->name)->class('form-control')->placeholder('Category Name') }}
                                        @error('name')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('category_type', $types, $category->category_type)->class('form-control')->placeholder('Select') }}
                                        @error('category_type')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->number('display_order', $category->display_order, 0, 100, '1')->class('form-control')->placeholder('0') }}
                                        @error('display_order')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('status', status(), $category->status)->class('form-control')->placeholder('Select') }}
                                        @error('status')
