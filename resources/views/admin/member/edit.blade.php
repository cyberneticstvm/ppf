        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('POST', (Auth::user()->type == 'admin' || Auth::user()->type == 'editor') ? route('member.update', $member->id) : route('user.profile.update', $member->id))->class('theme-form')->acceptsFiles()->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2">
                                        <label class="col-form-label pt-0" for="reference">Referred by </label>
                                        {{ html()->text('reference', $member->reference)->class('form-control')->placeholder('Referred by') }}
                                    </div>
                                    <div class="col-md-3">
