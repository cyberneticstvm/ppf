                ...
                <div class="col-lg-12">
                    <div class="breadcrumbs creote">
                        <ul class="breadcrumb m-auto">
                            <li><a href="/">Home</a> </li>
                            <li><a href="{{ route('schemes') }}">Government Schemes</a></li>
                            <li class="active">{{ $scheme->name }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <section class="blog_single_details_outer">
                        <div class="single_content_upper">
                            <div class="blog_feature_image">
                                <img src="{{ ($scheme->image) ? asset($scheme->image) : asset('frontend/assets/images/home/job.webp') }}" class="wp-post-image" alt="img">
                            </div>
                            <!--===============spacing==============-->
                        ...
                        <div class="text-center">
                            <a href="{{ ($scheme->document) ? asset($scheme->document) : '#' }}" target="_blank">Attachment</a>
                        </div>
                        <div class="related_post">
                            <div class="title_sections_inner">
                                <h2>Recents Schemes</h2>
                            </div>
                            <!-- Swiper -->
            ...
            <aside id="secondary" class="widget-area all_side_bar col-lg-4 col-md-12 col-sm-12">
                <div class="side_bar">
                    <div class="widgets_grid_box">
                        <h2 class="widget-title">Recent Schemes</h2>
