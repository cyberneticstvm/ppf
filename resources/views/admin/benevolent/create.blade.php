...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Benevolent Activity Create</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Benevolent Activity Create</li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('POST', route('benevolent.save'))->class('theme-form')->acceptsFiles()->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="col-form-label pt-0 req" for="name">Activity Name / Title </label>
                                        {{ html()->text('name', old('name'))->class('form-control')->placeholder('Activity Name') }}
                                        @error('name')
                                        <small class="text-danger">{{ $errors->first('name') }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-3">
                                        <label class="col-form-label pt-0 req" for="category_id">Activity </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-form-label pt-0 req" for="image">Activity Image </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-form-label pt-0" for="gallery_id">Activity Gallery </label>
                                    ...
                                    <div class="col-md-12">
                                        <label class="col-form-label pt-0 req" for="status">Activity Description </label>
