...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Advertisement Create</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Advertisement Create</li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('POST', route('advertisement.save'))->class('theme-form')->acceptsFiles()->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="col-form-label pt-0 req" for="name">Advertisement Name / Title </label>
                                        {{ html()->text('name', old('name'))->class('form-control')->placeholder('Advertisement Name') }}
                                        @error('name')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('position', positions(), old('position'))->class('form-control')->placeholder('Select') }}
                                        @error('position')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {{ html()->text('url', old('url'))->class('form-control')->placeholder('Ad URL') }}
                                    </div>
                                    <div class="col-md-12">
                                        <label class="col-form-label pt-0 req" for="status">Ad Description </label>
                                        {{ html()->textarea('description', old('description'))->class('form-control editor')->placeholder('Ad Description') }}
                                        @error('description')
