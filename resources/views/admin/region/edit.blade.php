...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Regional Official Update</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Regional Official Update</li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('POST', route('region.update', $region->id))->class('theme-form')->acceptsFiles()->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="col-form-label pt-0 req" for="name">Official Name </label>
                                        {{ html()->text('name', $region->name)->class('form-control')->placeholder('Official Name') }}
                                        @error('name')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('panel', array('convener' => 'Convener', 'joint_convener' => 'Joint Convener', 'executive_committee_member' => 'Executive Committee Member'), $region->panel)->class('form-control')->placeholder('Select') }}
                                        @error('panel')
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {{ html()->text('display_order', $region->display_order)->class('form-control')->placeholder('Display Order') }}
                                    </div>
                                    <div class="col-md-4">
                                        <label class="col-form-label pt-0 req" for="image">Official Image </label>
                                        {{ html()->file('image', $region->image)->class('form-control') }}
